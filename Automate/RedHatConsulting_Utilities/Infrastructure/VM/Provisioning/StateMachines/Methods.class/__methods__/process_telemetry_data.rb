...
begin
  ...
  set_provisioning_telemetry_custom_attribute(vm, 'Time: Request Created',               prov.created_on.in_time_zone(current_time_zone))
  set_provisioning_telemetry_custom_attribute(vm, 'Time: Request Completed',             now)
  set_provisioning_telemetry_custom_attribute(vm, 'Hour: Request Created',               prov.created_on.in_time_zone(current_time_zone).hour)
