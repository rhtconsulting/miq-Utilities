...
* Infrastructure
  ...
  * Providers / Clusters / Hosts
    ...
    * Method for determining templates based on a selected location tag on providers and OS tag on templates
* Service
...
* System
  * Dynamic Dialog methods and instances for getting tags and tag categories
...
3. Git URL: `https://github.com/RedHatOfficial/miq-Utilities.git`
4. Submit
